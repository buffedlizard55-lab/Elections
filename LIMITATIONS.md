...
- **The 2026 season's numbers are mark-to-market on 3 captured days, with 9 of 12 entrants unranked.** `crosslayer-arb` shows 3 fills and no rank; `combo-coherence` found no fee-clearing basket in the window and its best observed edge was negative. None of this is evidence against the theses — it is evidence that the window is short.

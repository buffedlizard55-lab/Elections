...
|---|---|---|
| Sources | `data/sources/master.json` — **73 verified entries** (32 on 2026-09-18 + 21 + 20 on 2026-09-19) | `data/master_sources.json` + `.csv` — 20 live-only entries + `data/flagged_sources.json` (7 excluded with reasons) |
